        ...
        <div>
            <div className="about-div-parent">
                ...
                <div className="about-div">
                    ...
                    <p className="about-text">Why? We only have you in mind. We created a platform for you to feel safe about finding not only the tattoo you want, but also who will do it for you. Get updates on the nearest shops as well as their ratings, prices and links. Have any other questions? Feel free to contact a dev!</p>
                </div>
                <div className="about-div">
                    <img className="about-img" src="https://i.imgur.com/QSrF8Tb.png" alt=""/>
                    <h5 className="about-title">How do you do it?</h5>
                    <p className="about-text">We do it with programming by incorporating the following: Javascript, Node.js, React, MongoDB, Mongoose, Axios, and Cloudinary. We also included some cool APIs provided by Pexel (Image API) and Yelp (Business API).</p>
                </div><br/>
                <div className="about-div">
                    <img className="about-img" src="https://i.imgur.com/p7fzTja.png" alt=""/>
                    <h5 className="about-title">Navigation</h5>
                    <p className="about-text">First, we would like to thank you for visting our platform. To navgiate, simply Sign Up or Login using the links above. Once you log in, you will be able to use the Tattoo Shops, Image Search, and Profile features for users. Feel free to update your user information and profile picture.</p>
                </div>
                <div className="about-div">
                    <img className="about-img" src="https://i.imgur.com/BOkBW36.png" alt=""/>
                    <h5 className="about-title">Any Future Updates?</h5>
                    <p className="about-text">Of course! This site will be an ongoing project. We are thinking of cool ways to give you updates, use of better APIs, and make the site more user friendly. We also would like to add features that will help you choose artists more efficiently with live Twitter and Instagram feeds.</p>
                </div>
            </div><br/>
                ...
                <div className="row-dev">
                    ...
                    <div className="col-sm-6">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://www.linkedin.com/in/amari-james" className="btn"><img className="linkedin-img" src="https://i.imgur.com/oAwmaXD.png" alt="linkedin-link"/></a>
                        </div>
                        </div>
                    </div>
                    <div className="col-sm-6">
